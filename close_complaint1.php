...
<html>
  ...
  <div class="animated fadeIn">
	...
	<?php 
		...
		<form action="close_complaint2.php" method="post">
		<table>
			<br>
			<tr>
				<th><select name="reason">
					<option>Duplicate Entry</option>
					<option>Complaint Resolved</option>
					<option>Wrong UDISE</option>
					<option>Wrong Details provided</option>
				</select></th>
			</tr>
			<tr><td><input type="hidden" name="id" value='$id'></td></tr>
			<tr><br>
				<th><input type="submit" value="Close Complaint"></th>
			</tr>
		</table>
	</form> 
		<?php
